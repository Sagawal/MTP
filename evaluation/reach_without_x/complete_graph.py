...
def log(Q_list, res, answer, args):
    ...
    newpath = 'log/reach_complete/'+args.model+'-'+args.mode+'-'+time+'-'+args.prompt
    if args.SC == 1:
        newpath = newpath + "+SC"
...
def main():
    ...
    for i in tqdm(range(25)):
        with open("generation/complete_graphs/"+args.mode+"/complete_graph_"+str(i)+".txt","r") as f, open("answers/output1_complete_hard.txt","a", encoding="utf-8") as f5:

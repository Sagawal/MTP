...
min_nodes = 11    # Minimum number of nodes in a graph
max_nodes = 13   # Maximum number of nodes in a graph


# Directory to save the edge files
output_dir = "D:\\IITDelhi\\Sem5\\Project\\NLGraph-main\\NLGraph-main\\NLGraph\\reach_not_through_x\\graph" + "\\hard" + "\\complete"
...
for graph_id in range(max_nodes+1-min_nodes):
    for i in range(5):
        ...
        file_path = os.path.join(output_dir, f"graph{graph_id*5+i}.txt")

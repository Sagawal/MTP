...
def save_graph(graph, name, output_dir="generation\\dense_graphs\\easy"):
...
def generate_random_graphs(node_counts, edge_probs=[0.6]):
    ...
    for n in node_counts:
        for p in edge_probs:
            ...
            save_graph(G_er, f"dense_graph_{ind}")
            ind += 1
...
if __name__ == "__main__":
    ...
    node_counts = []
    for i in range(40):
        node_counts.append(random.choice(range(4,14)))   # easy- range(4,14)   med- (14,28)   hard- (28,36)
